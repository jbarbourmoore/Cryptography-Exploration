...
class SHA3_UnitTest(unittest.TestCase):
    ...
    def test_state_array_to_bit_string_25bit(self):
        ...
        state_array = self.sha3_224.bitStringToStateArray(bit_string)
        converted_back = self.sha3_224.stateArrayToBitString(state_array)
    ...
    def test_sha3_224_theta(self):
        ...
        binary_before_theta = self.sha3_224.h2b(expected_before_theta)
        self.assertEqual(expected_before_theta.replace(" ",""),self.sha3_224.b2h(binary_before_theta))
        self.assertEqual(binary_before_theta,self.sha3_224.stateArrayToBitString(self.sha3_224.bitStringToStateArray(binary_before_theta)))
        theta_result = self.sha3_224.theta(self.sha3_224.bitStringToStateArray(binary_before_theta))
        self.assertEqual(self.sha3_224.b2h(self.sha3_224.stateArrayToBitString(theta_result)),expected_after_theta.replace(" ",""))
    ...
    def test_sha3_224_rho(self):
        ...
        binary_after_theta = self.sha3_224.h2b(expected_after_theta)
        self.assertEqual(expected_after_theta.replace(" ",""),self.sha3_224.b2h(binary_after_theta))
        self.assertEqual(binary_after_theta,self.sha3_224.stateArrayToBitString(self.sha3_224.bitStringToStateArray(binary_after_theta)))
        rho_result = self.sha3_224.rho(self.sha3_224.bitStringToStateArray(binary_after_theta))
        self.assertEqual(self.sha3_224.b2h(self.sha3_224.stateArrayToBitString(rho_result)),expected_after_rho.replace(" ",""))
    ...
    def test_sha3_224_pi(self):
        ...
        self.assertEqual(binary_after_rho,self.sha3_224.stateArrayToBitString(self.sha3_224.bitStringToStateArray(binary_after_rho)))
        pi_result = self.sha3_224.pi(self.sha3_224.bitStringToStateArray(binary_after_rho))
        self.assertEqual(format_bit_as_hex_string(self.sha3_224.stateArrayToBitString(pi_result)),expected_after_pi.replace(" ",""))
    ...
    def test_sha3_224_chi(self):
        ...
        self.assertEqual(binary_after_pi,self.sha3_224.stateArrayToBitString(self.sha3_224.bitStringToStateArray(binary_after_pi)))
        chi_result = self.sha3_224.chi(self.sha3_224.bitStringToStateArray(binary_after_pi))
        self.assertEqual(format_bit_as_hex_string(self.sha3_224.stateArrayToBitString(chi_result)),expected_after_chi.replace(" ",""))
    ...
    def test_sha3_224_iota(self):
        ...
        binary_after_chi = self.sha3_224.h2b(expected_after_chi)
        self.assertEqual(expected_after_chi.replace(" ",""),self.sha3_224.b2h(binary_after_chi))
        self.assertEqual(binary_after_chi,self.sha3_224.stateArrayToBitString(self.sha3_224.bitStringToStateArray(binary_after_chi)))
        iota_result = self.sha3_224.iota(self.sha3_224.bitStringToStateArray(binary_after_chi),12+21-33)
        self.assertEqual(self.sha3_224.b2h(self.sha3_224.stateArrayToBitString(iota_result)),expected_after_iota.replace(" ",""))
    ...
    def test_sha3_224_iota_second(self):
        ...
        self.assertEqual(expected_after_chi.replace(" ",""),self.sha3_224.b2h(binary_after_chi))
        self.assertEqual(binary_after_chi,self.sha3_224.stateArrayToBitString(self.sha3_224.bitStringToStateArray(binary_after_chi)))
        iota_result = self.sha3_224.iota(self.sha3_224.bitStringToStateArray(binary_after_chi),2)
        self.assertEqual(self.sha3_224.b2h(self.sha3_224.stateArrayToBitString(iota_result)),expected_after_iota.replace(" ",""))
