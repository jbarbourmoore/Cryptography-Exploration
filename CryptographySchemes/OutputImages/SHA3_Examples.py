...
class SHA3_UnitTest(unittest.TestCase):
    ...
    def test_sha224(self):
        ...
        print(f"Testing SHA3-224 With 5 Bit Input {bit_array_input}")
    ...
    def test_sha256(self):
        ...
        handler_expected = SHA3_ValueHandler.fromHexString(expected_result)
        print(f"Testing SHA3-256 With 5 Bit Input {bit_array_input}")
        print(f"Expected Hash : {handler_expected.getHexString()}")
        print(f"Actual Hash   : {result.getHexString()}")
    ...
    def test_sha384(self):
        ...
        handler_expected = SHA3_ValueHandler.fromHexString(expected_result)
        print(f"Testing SHA3-384 With 5 Bit Input {bit_array_input}")
        print(f"Expected Hash : {handler_expected.getHexString()}")
        print(f"Actual Hash   : {result.getHexString()}")
    ...
    def test_sha512(self):
        ...
        handler_expected = SHA3_ValueHandler.fromHexString(expected_result)
        print(f"Testing SHA3-512 With 5 Bit Input {bit_array_input}")
        print(f"Expected Hash : {handler_expected.getHexString()}")
        print(f"Actual Hash   : {result.getHexString()}")
    ...
    def test_shake_128(self):
        ...
        handler_expected = SHA3_ValueHandler.fromHexString(expected_result)
        print(f"Testing Shake-128 With 5 Bit Input {bit_array_input} and {digest_length_hex*4} bit digest length")
        print(f"Expected Hash : {handler_expected.getHexString()[:digest_length_hex]}")
        print(f"Actual Hash   : {result.getHexString()}")
        ...
        result = shake.hashBitArray(bit_array_input,digest_length_hex*4)
        print(f"\nTesting Shake-128 With 5 Bit Input {bit_array_input} and {digest_length_hex*4} bit digest length")
        print(f"Expected Hash : {handler_expected.getHexString()[:digest_length_hex]}")
        print(f"Actual Hash   : {result.getHexString()}")
    ...
    def test_shake_256(self):
        ...
        handler_expected = SHA3_ValueHandler.fromHexString(expected_result)
        print(f"Testing Shake-256 With 5 Bit Input {bit_array_input} and {digest_length_hex*4} bit digest length")
        print(f"Expected Hash : {handler_expected.getHexString()[:digest_length_hex]}")
        print(f"Actual Hash   : {result.getHexString()}")
        ...
        result = shake.hashBitArray(bit_array_input,digest_length_hex*4)
        print(f"\nTesting Shake-256 With 5 Bit Input {bit_array_input} and {digest_length_hex*4} bit digest length")
        print(f"Expected Hash : {handler_expected.getHexString()[:digest_length_hex]}")
        print(f"Actual Hash   : {result.getHexString()}")
...
if __name__ == '__main__':
    print("- - - - - - - - - - - -")
    print("Testing SHA3 Implementations Against Known Values")
