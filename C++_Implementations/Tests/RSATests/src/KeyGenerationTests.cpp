...
/// @brief This unit tests generating a random key with bit length 2048 and using it to encrypt and decrypt a message 
TEST(KeyGenerationTests_ProbablyPrimeProvAux, prob_with_prov_2048_stand) {
    int keylength = 2048;
    int bitlen1 = 125;
    int bitlen2 = 140;
    int bitlen3 = 130;
    ...
    RSAKeyGenerationResult gen_res = my_key_gen.generateRSAKeysUsingProbablePrimesWithProvableAux(a, b, bitlen1, bitlen2, bitlen3, bitlen4, use_quintuple_form);
    const char *encrypted_message = gen_res.public_key_.encryptionPrimitive(input_message);
    const char *decrypted_message = gen_res.private_key_.decryptionPrimitive(encrypted_message);
...
/// @brief This unit tests generating a random key with bit length 3076 and using it to encrypt and decrypt a message 
TEST(KeyGenerationTests_ProbablyPrimeProvAux, prob_with_prov_3076_stand) {
    int keylength = 3076;
    int bitlen1 = 160;
    int bitlen2 = 140;
    int bitlen3 = 130;
...
/// @brief This unit tests generating a random key with bit length 7680 and using it to encrypt and decrypt a message 
TEST(KeyGenerationTests_ProbablyPrimeProvAux, prob_with_prov_7680_stand) {
    int keylength = 7680;
    int bitlen1 = 300;
    int bitlen2 = 200;
    int bitlen3 = 210;
...
/// @brief This unit tests generating a random key with bit length 15360 and using it to encrypt and decrypt a message 
TEST(KeyGenerationTests_ProbablyPrimeProvAux, prob_with_prov_15360_stand) {
    int keylength = 15360;
    int bitlen1 = 400;
    int bitlen2 = 250;
    int bitlen3 = 300;
...
/// @brief This unit tests generating a random key with bit length 2048 and using it to encrypt and decrypt a message 
TEST(KeyGenerationTests_ProbablyPrimeProbAux, prob_with_prob_2048_stand) {
    int keylength = 2048;
    int bitlen1 = 125;
    int bitlen2 = 140;
    int bitlen3 = 130;
    ...
    RSAKeyGenerationResult gen_res = my_key_gen.generateRSAKeysUsingProbablePrimesWithProbableAux(a, b, bitlen1, bitlen2, bitlen3, bitlen4, use_quintuple_form);
    const char *encrypted_message = gen_res.public_key_.encryptionPrimitive(input_message);
    const char *decrypted_message = gen_res.private_key_.decryptionPrimitive(encrypted_message);
...
/// @brief This unit tests generating a random key with bit length 3076 and using it to encrypt and decrypt a message 
TEST(KeyGenerationTests_ProbablyPrimeProbAux, prob_with_prob_3076_stand) {
    int keylength = 3076;
    int bitlen1 = 160;
    int bitlen2 = 140;
    int bitlen3 = 130;
...
/// @brief This unit tests generating a random key with bit length 7680 and using it to encrypt and decrypt a message 
TEST(KeyGenerationTests_ProbablyPrimeProbAux, prob_with_prob_7680_stand) {
    int keylength = 7680;
    int bitlen1 = 300;
    int bitlen2 = 200;
    int bitlen3 = 210;
...
/// @brief This unit tests generating a random key with bit length 15360 and using it to encrypt and decrypt a message 
TEST(KeyGenerationTests_ProbablyPrimeProbAux, prob_with_prob_15360_stand) {
    int keylength = 15360;
    int bitlen1 = 400;
    int bitlen2 = 250;
    int bitlen3 = 300;
