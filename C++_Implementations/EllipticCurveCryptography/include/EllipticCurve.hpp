...
enum EllipticCurves {
    SECP192R1_, SECP224R1_, SECP256R1_, SECP384R1_, SECP521R1_, ED25519, ED443
};
...
class WeirrstrassCurve : public EllipticCurve{
    ...
    public:
        ...
        /// @brief The default constructor for a Weirrstrass Curve
        WeirrstrassCurve();
        ...
        WeirrstrassCurve(std::string a_hex, std::string b_hex, std::string finite_field_hex, std::string gx_hex, std::string gy_hex, std::string n_hex);
...
class secp192r1 : public WeirrstrassCurve{
    public  : 
        secp192r1() : WeirrstrassCurve(
            ...
            "FFFFFFFFFFFFFFFFFFFFFFFF99DEF836146BC9B1B4D22831"   // n (The order of the curve)
        ){};
};
...
class secp224r1 : public WeirrstrassCurve{
    public  : 
        secp224r1() : WeirrstrassCurve(
            ...
            "FFFFFFFFFFFFFFFFFFFFFFFFFFFF16A2E0B8F03E13DD29455C5C2A3D"   // n (The order of the curve)
        ){};
};
...
class secp256r1 : public WeirrstrassCurve{
    public  : 
        secp256r1() : WeirrstrassCurve(
            ...
            "FFFFFFFF00000000FFFFFFFFFFFFFFFFBCE6FAADA7179E84F3B9CAC2FC632551"   // n (The order of the curve)
        ){};
};
...
class secp384r1 : public WeirrstrassCurve{
    public  : 
        secp384r1() : WeirrstrassCurve(
            ...
            "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFC7634D81F4372DDF581A0DB248B0A77AECEC196ACCC52973"   // n (The order of the curve)
        ){};
};
...
class secp521r1 : public WeirrstrassCurve{
    public  : 
        secp521r1() : WeirrstrassCurve(
            ...
            "01FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFA51868783BF2F966B7FCC0148F709A5D03BB5C9B8899C47AEBB6FB71E91386409"   // n (The order of the curve)
        ){};
};
