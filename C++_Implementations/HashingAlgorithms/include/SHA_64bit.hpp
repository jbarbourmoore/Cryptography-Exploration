#ifndef SHA_64bit_HPP
#define SHA_64bit_HPP
...
namespace sha64bit
{
    ...
    typedef array<word64, 16> block64;
    /// @brief The list of blocks in the message
    typedef vector<block64> message64;
} // namespace sha64bit
...
class SHA_64bit : public SHA {
        ...
        word64 ROTR(word64 input, int shift);
        ...
        word64 ROTL(word64 input, int shift);
        ...
        word64 hexStringToWord(string input);
        ...
        string wordToHexString(word64 input);
        ...
        word64 ch(word64 x, word64 y, word64 z);
...
class SHA512 : public SHA_64bit {
    protected :
        ...
        static const word64 H0_SHA512[8];
        ...
        virtual word64 getH0(int index);

        /// @brief This method returns the initial hash value for use with SHA256
        /// @return The constant word at that index
        virtual word64 getDigestSize();
        ...
        string hashMessageToHex(message64 input);
...
class SHA512_224 : public SHA512 {
    protected :
        ...
        /// @brief The starting hash values used in SHA-224 as listed in section 5.3.4 "SHA-224" of NIST FIPS 180-4
        static const word64 H0_SHA512_224[8];
...
class SHA512_256 : public SHA512 {
    protected :
        ...
        /// @brief The starting hash values used in SHA-224 as listed in section 5.3.4 "SHA-224" of NIST FIPS 180-4
        static const word64 H0_SHA512_256[8];
