...
class AES_GCM{
    ...
    public:
        ...
        static std::string GTCR(AESKeyTypes key_type, std::string key, AESDataBlock ICB, std::string hex_input);
        ...
        static GCM_EncyptionResult authenticatedEncryption(std::string P, AESKeyTypes key_type, std::string K, int t, std::string IV, std::string A);

        static void authenticatedDecryption();
