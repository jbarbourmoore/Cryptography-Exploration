...
/// @brief This class contains the functions for AES in Output Feedback Mode as defined in NIST SP 800 -38a 
/// https://nvlpubs.nist.gov/nistpubs/Legacy/SP/nistspecialpublication800-38a.pdf
class AES_OFB{

    public:
        /// @brief This method performs the AES cypher in CBC Mode from NIST SP 800 - 38a Section 6.4 "The Output Feedback Mode"
        ...
        /// @brief This method performs the AES inverse cypher in CBC Mode from NIST SP 800 - 38a Section 6.4 "The Output Feedback Mode"
